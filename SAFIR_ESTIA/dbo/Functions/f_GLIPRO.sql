...
AS  
BEGIN  
WITH GLIPRO_cte(FK_TIERS, PK_GROUPE, CORG, CJOURNAL, DATEC, DVAL, CCG, LIBELLE, SENS, MONTANT, CTYPECRI, NOPIECE, REF, TRAIT, TYPCPTA, PERIODE, BANAL, ORD, NODAC, INTERFACE, UTIL, INFO, ECCG, MTLET, CMANDAT, ECRAC_ID)
AS
(
	SELECT WGM.FK_TIERS
		 , WGM.PK_GROUPE
...
-- copy the required columns to the result of the function   
   INSERT @retGLIPRO 
   SELECT FK_TIERS, PK_GROUPE, CORG, CJOURNAL, DATEC, DVAL, CCG, LIBELLE, SENS, MONTANT, CTYPECRI, NOPIECE, REF, TRAIT, TYPCPTA, PERIODE, BANAL, ORD, NODAC, INTERFACE, UTIL, INFO, ECCG, MTLET, CMANDAT, ECRAC_ID
   FROM GLIPRO_cte   
   RETURN  
END;