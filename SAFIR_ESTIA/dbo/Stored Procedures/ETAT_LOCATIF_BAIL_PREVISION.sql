...
SELECT REQ.DT_REF
     ...
     , REQ.PAIEMENT
  	 , REQ.CHEMIN_MANDAT
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) -2, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN_PREC2
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) -1, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN_PREC1
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS), REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +1, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN1
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +2, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN2
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +3, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN3
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +4, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN4
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +5, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN5
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +6, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN6
 	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +7, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN7
 	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +8, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN8
	 , (select MT_FRANCHISE from f_GET_ANNUAL_RENT_FREE(DATEPART(YEAR, @PK_TEMPS) +9, REQ.FK_BAIL)) MT_LOYER_FRANCHISE_AN9
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) -2, REQ.FK_BAIL)) AS MT_PALIER_AN_PREC2 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) -1, REQ.FK_BAIL)) AS MT_PALIER_AN_PREC1 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS), REQ.FK_BAIL)) AS MT_PALIER_AN 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +1, REQ.FK_BAIL)) AS MT_PALIER_AN1 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +2, REQ.FK_BAIL)) AS MT_PALIER_AN2 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +3, REQ.FK_BAIL)) AS MT_PALIER_AN3 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +4, REQ.FK_BAIL)) AS MT_PALIER_AN4 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +5, REQ.FK_BAIL)) AS MT_PALIER_AN5
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +6, REQ.FK_BAIL)) AS MT_PALIER_AN6 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +7, REQ.FK_BAIL)) AS MT_PALIER_AN7 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +8, REQ.FK_BAIL)) AS MT_PALIER_AN8 
	 , (select MT_PALIER from dbo.f_GET_ANNUAL_LEASE_ALLOWANCES(@PK_TEMPS, DATEPART(YEAR, @PK_TEMPS) +9, REQ.FK_BAIL)) AS MT_PALIER_AN9 
FROM REQ
