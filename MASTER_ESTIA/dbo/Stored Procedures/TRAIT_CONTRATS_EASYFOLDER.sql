...
INSERT INTO WRK_INTERFACE_EASYFOLDER_CONTRATS(PK_TEMPS, ACTION, IDENTIFIANT_DREAM_IMMEUBLE, IDENTIFIANT_ESTIA_IMMEUBLE, NUM_CONTRAT, NOM_IMMEUBLE_ESTIA, LB_CONTRAT, DT_FIN_PRESTATION)
...
(
	SELECT P.CD_IMMEUBLE_DREAM AS IDENTIFIANT_DREAM_IMMEUBLE
		 ...
		 , CAST(CTR.CCONTFRS AS numeric(10,0)) AS NUM_CONTRAT
		 , CONCAT(T.LTIERS, + ' - ' + CONVERT(VARCHAR(10), CAST(CTR.CCONTFRS AS numeric(10,0))) + ' - ' + CTR.LIBFAC) AS LB_CONTRAT
