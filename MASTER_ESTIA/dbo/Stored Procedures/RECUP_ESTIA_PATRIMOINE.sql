...
--CRTIERS: TABLE DES COMPTE-RENDUS DE MODIFICATIONS
INSERT INTO L_REPURERATION_ESTIA (NOM_TABLE, IND_SUCCES, DT_DEBUT) VALUES ('CRTIERS', 'N', GETDATE())
SET @ID_LOG = @@IDENTITY
TRUNCATE TABLE ESTIA_CRTIERS
INSERT INTO ESTIA_CRTIERS (ADRCOMP1, ADRCOMP2, BDIS1, BDIS2, CAPE1, CAPE2, CCOMM1, CCOMM2, CFONCTIO1, CFONCTIO2, COMMUNE1, COMMUNE2, CPAYS1, CPAYS2, CPOS1, CPOS2, CPROF1, CPROF2, CQC1, CQC2, CSITUFA1, CSITUFA2, CSTATUT1, CSTATUT2, CTIERS, CTYPTIERS, CUTIL, DATEC, HEURE, INSEE1, INSEE2, INTERNET1, INTERNET2, LTIERS1, LTIERS2, M1, M2, POUM1, POUM2, PRENOM1, PRENOM2, RTIERS1, RTIERS2, RUE1, RUE2, SIRET1, SIRET2, TEL1, TEL2, TELECOP1, TELECOP2, TELEX1, TELEX2, TYPMOD)
SELECT ADRCOMP1, ADRCOMP2, BDIS1, BDIS2, CAPE1, CAPE2, CCOMM1, CCOMM2, CFONCTIO1, CFONCTIO2, COMMUNE1, COMMUNE2, CPAYS1, CPAYS2, CPOS1, CPOS2, CPROF1, CPROF2, CQC1, CQC2, CSITUFA1, CSITUFA2, CSTATUT1, CSTATUT2, CTIERS, CTYPTIERS, CUTIL, DATEC, HEURE, INSEE1, INSEE2, INTERNET1, INTERNET2, LTIERS1, LTIERS2, 0M1, 0M2, POUM1, POUM2, PRENOM1, PRENOM2, RTIERS1, RTIERS2, RUE1, RUE2, SIRET1, SIRET2, TEL1, TEL2, TELECOP1, TELECOP2, TELEX1, TELEX2, TYPMOD 
FROM ESTIA_SOURCE..CRTIERS
SET @NB = @@ROWCOUNT
UPDATE L_REPURERATION_ESTIA SET IND_SUCCES = 'O', DT_FIN = GETDATE(), NB_LIGNES = @NB WHERE ID_LOG = @ID_LOG
...
--EBUDLOC: TABLE DES ENTETES BUDGET CHARGES
INSERT INTO L_REPURERATION_ESTIA (NOM_TABLE, IND_SUCCES, DT_DEBUT) VALUES ('EBUDLOC', 'N', GETDATE())
SET @ID_LOG = @@IDENTITY
TRUNCATE TABLE ESTIA_EBUDLOC
INSERT INTO ESTIA_EBUDLOC (CORG , CAGENCE , CGROUPE , CBUDLOC , VERSION , LBUDLOC , DDEB , DFIN , VOTE , METHREG , TYPBUD , OBUDLOC , COMMENT , TRIG , MIGCOMPT)
SELECT CORG , CAGENCE , CGROUPE , CBUDLOC , VERSION , LBUDLOC , DDEB , DFIN , VOTE , METHREG , TYPBUD , OBUDLOC , COMMENT_ , TRIG , MIGCOMPT
FROM ESTIA_SOURCE..EBUDLOC
SET @NB = @@ROWCOUNT
UPDATE L_REPURERATION_ESTIA SET IND_SUCCES = 'O', DT_FIN = GETDATE(), NB_LIGNES = @NB WHERE ID_LOG = @ID_LOG
...
--LBUDLOC: TABLE DES LIGNES BUDGET CHARGES
INSERT INTO L_REPURERATION_ESTIA (NOM_TABLE, IND_SUCCES, DT_DEBUT) VALUES ('LBUDLOC', 'N', GETDATE())
SET @ID_LOG = @@IDENTITY
TRUNCATE TABLE ESTIA_LBUDLOC
INSERT INTO ESTIA_LBUDLOC (CORG, CAGENCE, CGROUPE, CBUDLOC, VERSION, NOLIG, CCRITDP, CSCRITDP, MONTANT, LIB, CRUB, MONTANTREF, POURCEVOL, TYPEREF, TRIG, MIGCOMPT, MTHT, MTTVA, MTREFHT, MTREFTVA, DDEBIMP, DFINIMP, BUDPROP, ADF, TEXTPRO)
SELECT CORG, CAGENCE, CGROUPE, CBUDLOC, VERSION, NOLIG, CCRITDP, CSCRITDP, REPLACE(MONTANT, ',','.') AS MONTANT, LIB, CRUB, REPLACE(MONTANTREF, ',','.') AS MONTANTREF, REPLACE(POURCEVOL, ',','.') AS POURCEVOL, TYPEREF, TRIG, MIGCOMPT, REPLACE(MTHT, ',','.') AS MTHT, REPLACE(MTTVA, ',','.') AS MTTVA, REPLACE(MTREFHT, ',','.') AS MTREFHT, REPLACE(MTREFTVA, ',','.') AS MTREFTVA, DDEBIMP, DFINIMP, BUDPROP, ADF, TEXTPRO
FROM ESTIA_SOURCE..LBUDLOC
SET @NB = @@ROWCOUNT
UPDATE L_REPURERATION_ESTIA SET IND_SUCCES = 'O', DT_FIN = GETDATE(), NB_LIGNES = @NB WHERE ID_LOG = @ID_LOG
...
INSERT INTO ESTIA_MENPRIN (UTIL, ADMIN, LISTAG, LISTORG, LUTIL, INTERNET)
SELECT UTIL, ADMIN, LISTAG, LISTORG, LUTIL, INTERNET
...
--PREPOPE: TABLE DES TYPES D'OPERATIONS ET GROUPE D'UNE OPERATION OU D'UN MARCHE
INSERT INTO L_REPURERATION_ESTIA (NOM_TABLE, IND_SUCCES, DT_DEBUT) VALUES ('PREPOPE', 'N', GETDATE())
SET @ID_LOG = @@IDENTITY
TRUNCATE TABLE ESTIA_PREPOPE
INSERT INTO ESTIA_PREPOPE (CORG, COPE, CDEPR, NORD, CSTE, CTYPOP, CSECTREG, POURCENT, CSECTANA, CTRANCHE, ASSUTVA, LASM, TEMA, BANAL, RECUP, CACCESS, CNATANA, PRORATA, CTVA, CPATRI, PEREPUD_ID, POIDS, STVA, COMMENT, GROUPE_ID, MIGCOMP, DRECEPCOMPO, DIMMOCOMPO, CMODCOMP)
SELECT CORG, COPE, CDEPR, NORD, CSTE, CTYPOP, CSECTREG, POURCENT, CSECTANA, CTRANCHE, ASSUTVA, LASM, TEMA, BANAL, RECUP, CACCESS, CNATANA, PRORATA, CTVA, CPATRI, PEREPUD_ID, POIDS, STVA, COMMENT, GROUPE_ID, MIGCOMP, DRECEPCOMPO, DIMMOCOMPO, CMODCOMP
FROM ESTIA_SOURCE..PREPOPE
SET @NB = @@ROWCOUNT
UPDATE L_REPURERATION_ESTIA SET IND_SUCCES = 'O', DT_FIN = GETDATE(), NB_LIGNES = @NB WHERE ID_LOG = @ID_LOG
...
UPDATE L_REPURERATION_ESTIA SET IND_SUCCES = 'O', DT_FIN = GETDATE(), NB_LIGNES = @NB WHERE ID_LOG = @ID_LOG
  ...
  --SECURITE: TABLE DES SECURITE
INSERT INTO L_REPURERATION_ESTIA (NOM_TABLE, IND_SUCCES, DT_DEBUT) VALUES ('SECURITE', 'N', GETDATE())
SET @ID_LOG = @@IDENTITY
TRUNCATE TABLE ESTIA_SECURITE
INSERT INTO ESTIA_SECURITE (CLEPRIN,  CLESEC, CODCHAMP, CODFONCT, DATE, DOMAINE, ENTIPRIN, ENTISEC, HEURE, LACTIF, LIBCHAMP, TRIG, UTIL, VALAPMOD, VALAVMOD)
SELECT CLEPRIN,  CLESEC, CODCHAMP, CODFONCT, DATE, DOMAINE, ENTIPRIN, ENTISEC, HEURE, LACTIF, LIBCHAMP, TRIG, UTIL, VALAPMOD, VALAVMOD
FROM ESTIA_SOURCE..SECURITE
SET @NB = @@ROWCOUNT
UPDATE L_REPURERATION_ESTIA SET IND_SUCCES = 'O', DT_FIN = GETDATE(), NB_LIGNES = @NB WHERE ID_LOG = @ID_LOG
