...
ISNULL(SUBSTRING(DSIGNLOC, 7, 2) + SUBSTRING(DSIGNLOC, 4, 2) + LEFT(DSIGNLOC, 2), '') AS DSIGNLOC, ISNULL(DRENOUV, '') AS DRENOUV, DREEXAM, TRIG, CCOMPTE, NOBAIL, TEMOIN, DREPONSE
...
ISNULL(SUBSTRING(DEFFET, 7, 2) + SUBSTRING(DEFFET, 4, 2) + LEFT(DEFFET, 2), '') AS DEFFET, 
