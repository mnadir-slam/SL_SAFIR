...
SELECT @DT_REF AS DT_REF, @DT AS PK_TEMPS, W.FK_LOCAL AS PK_LOT, W.FK_PROPRIETAIRE AS FK_PROPRIETAIRE,
       ...
       REV.CD_INDICE_INITIAL, REV.DT_INDICE_INITIAL AS MOIS_INDICE_INITIAL, REV.VAL_INDICE_INITIAL, REV.LB_INDICE_INITIAL,
       REV.CD_INDICE_ACTUEL, REV.DT_INDICE_ACTUEL AS MOIS_INDICE_ACTUEL, REV.VAL_INDICE_ACTUEL, REV.LB_INDICE_ACTUEL,
       REV.CD_PROCHAIN_INDICE, REV.DT_PROCHAIN_INDICE AS MOIS_PROCHAIN_INDICE, REV.VAL_PROCHAIN_INDICE, REV.LB_PROCHAIN_INDICE,
       REV.DT_REVISION_PRECEDENTE, REV.DT_PROCHAINE_REVISION,
