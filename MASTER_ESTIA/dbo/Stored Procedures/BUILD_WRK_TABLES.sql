...
-- Debut modif MNA 20190212		   
WHERE ISNULL(WLB.DT_BREAK7, ISNULL(WLB.DT_BREAK6, ISNULL(WLB.DT_BREAK5, ISNULL(WLB.DT_BREAK4, ISNULL(WLB.DT_BREAK3, ISNULL(WLB.DT_BREAK2, WLB.DT_BREAK1)))))) > @DT
-- Fin modif MNA 20190212
...
UPDATE WRK_HQRBAIL
SET DT_PRCH_TRIEN_POT = CASE WHEN @DT <= DT_TRIEN_POT_1 THEN DT_TRIEN_POT_1
...
WHERE LOCATION.DATENTQUIT <> ISNULL(LOCATION.DATSORQUIT, '29990101')
-- Debut modif MNA 20190319 : suppression bail 
AND (LOCATION.CCOMPTE + CAST(LOCATION.NOBAIL AS VARCHAR(2)) + CAST(LOCATION.CLOCAL AS VARCHAR(10)) <> '0000000554113001')
-- Fin modif MNA 20190319
...
DELETE FROM WRK_HISTO_LOT
WHERE CORG = '11' AND CGROUPE = '1763' AND CLOCAL = 3004 AND DT_DEBUT_RAT = '20150701'
